...
[![Header](https://i.ibb.co/5YLjsDs/Screenshot-2021-04-25-16-07-58.png "Header")](https://pashakun.com/)
...
- sudo su (enter your password kali linux user)
- apt-get update -y
- apt-get upgrade -y
- git clone https://github.com/pashayogi/CmsXploit
- cd CmsXploit
- use python2 bro
- pythn2 brute.py
